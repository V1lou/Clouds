...
## Итоговая таблица
Результатом работы является таблица. В полном объёме можно увидеть её перейдя по [**ссылке**](https://github.com/V1lou/Clouds/blob/main/LAB%20№1%20(analytical)/aws_team_3.xlsx) .
...
| Storage                      | Database                            | AmazonQLDB                       | IO requests per second         | AmazonQLDB         | %IO-Request                     |                                           | ***Yandex Database                               |
